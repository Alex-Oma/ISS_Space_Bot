...
from spacex_api import get_next_launch_details_message
...
def main():
    ...
    # print the response message
            # Let's get the next SpaceX launch details using the function from spacex_api.py
            next_launch_message = get_next_launch_details_message(spacex_base_url)

            print("Sending to Webex: " + responseMessage + next_launch_message)
